...
var ListSegment = function (_Model) {
  ...
  _createClass(ListSegment, null, [{
    ...
    value: function save(item) {
      if (this.isValid(item)) return _get(ListSegment.__proto__ || Object.getPrototypeOf(ListSegment), 'save', this).call(this, item);
    ...
    get: function get() {
      return _joi2.default.object({
        ...
        conditionMatch: _joi2.default.string().required(),
        conditions: _joi2.default.array().items(_joi2.default.object().keys({
          conditionType: _joi2.default.string().required(),
          condition: _joi2.default.object().keys({
            op: _joi2.default.string().required(),
