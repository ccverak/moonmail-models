...
var ListSegment = function (_Model) {
  ...
  function ListSegment() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(ListSegment).apply(this, arguments));
  }

  _createClass(ListSegment, null, [{
    key: 'save',
    value: function save(item) {
      if (this.isValid(item, { allowUnknown: true })) return _get(Object.getPrototypeOf(ListSegment), 'save', this).call(this, item);
    ...
    value: function update(params, hash, range) {
      ...
      if (params.conditions) {
        return this.validateConditions(params.conditions).then(function () {
          return _get(Object.getPrototypeOf(ListSegment), 'update', _this2).call(_this2, params, hash, range);
        });
      }
      return _get(Object.getPrototypeOf(ListSegment), 'update', this).call(this, params, hash, range);
    }
  }, {
    key: 'validConditions',
